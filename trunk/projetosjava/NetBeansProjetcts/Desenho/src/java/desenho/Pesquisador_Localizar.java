 ...
 *
 * @version Pesquisador_Localizar.java
 * @version Created on Aug 3, 2009, 9:49:03 AM
 * @author marcelo
 */

public class Pesquisador_Localizar extends AbstractPageBean {
    ...
    public void init() {
        ...
        try {
            ...
            log("Pesquisador_Localizar Initialization Failure", e);

 ...
 *
 * @version Page1.java
 * @version Created on Aug 4, 2009, 9:21:43 AM
 * @author marcelo
 */
...
public class Page1 extends AbstractPageBean {
    ...
    public void setSecretField1(HtmlInputSecret his) {
        this.secretField1 = his;
    }
    ...
    public String button1_action() {
        ...
        pesquisador.setNome((String) this.textField1.getValue());
        pesquisador.setNome((String) this.secretField1.getValue());
        if(pesquisadorService.ListarPorUsuarioSenha(pesquisador) == null ){
            return "falha";
        }
        return "sucesso";
    }
